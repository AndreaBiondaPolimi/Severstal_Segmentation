...
\section{Introduction}
   The proposed solution takes in input image of steel sheet that comes from high-frequency cameras and output same-size segmented image, which contains the area of the defect(s) identified (if any) and the corresponding type. The types of defects that is possible to face are 
   pitting (1), inclusion(2), scratches(3) and corrosion(4). \\
