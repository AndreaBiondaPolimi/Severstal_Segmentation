...
\section{Proposed approach}
   ...
   The semantic segmentation task is performed by a U-Net based model, in my experiments I have tried 3 different U-Net encoders: ResNet34, ResNet50 and EfficientNet-B3, in the following I will refer to EfficientNet-B3 model only since it has given the best result.
   ...
   The classification task is delegated to a standard binary classifier, in my experiments I have tried two different models: ResNet34 and ResNet50, in the following I will refer to \textcolor{red}{ResNet50} only since it has given the best result.
...
\section{Experiments}
   \subsection{Segmentation}
      \paragraph{data preparation}
         random crop: balanced and avoid black
         use defective only or not (with experiments on effb3)
      \paragraph{experiment setup}
         training parameters
      \paragraph{results and discussion}
         compare 3 encoders
         compare defective only or not
         image of results and false defect mistake
