...
\section{Introduction}
   ...
   dopo:The types of defects can be classified in pitting (1), inclusion(2), scratches(3) and corrosion(4). HERE THE IMAGES}
...
pensavo di mettere semantic segmentation, unet, (resnet), image classification
