...
\begin{abstract}
   ...
   The dataset is composed of both non-defective and defective images, where the largest part (about xxperc) belongs to the first class. \\


   Unbalanced data issue is one of the biggest challenge of the problem, in this solution the classification model is used as the first stage of the pipeline to separate defective from non-defective images, while the segmentation one, trained on defective only, is used to properly identify and classify defects. (163) \\ 
